...
:_summary: Directrius per a definir el nou model de relació amb els proveïdors de tecnologia basat en el xref:tech-practices:ROOT:aim-and-scope.adoc[Codi de Pràctiques Tecnològiques].
//
