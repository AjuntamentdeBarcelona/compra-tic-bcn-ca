...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/ict-procurement-bcn-ca
//
// MANDATORY.
:_url: https://barcelona.cat/digitalstandards/ca/ict-procurement/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Compra pública de TIC
//
...
:_summary: Directrius per a definir el nou model de relació amb els proveïdors de tecnologia basat en el https://www.barcelona.cat/digitalstandards/ca/tech-practices[Codi de Pràctiques Tecnològiques].
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: estàndards ètics digitals, drets digitals, ajuntament de Barcelona, compra TIC
//
...
Aquest document és part de https://www.barcelona.cat/digitalstandards/ca[Estàndards Digitals Ètics] de l'Ajuntament de Barcelona.
